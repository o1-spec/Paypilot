  ...
  return (
    <div className="relative min-h-screen bg-[#F8FAFC] text-[#0F172A] flex flex-col overflow-x-hidden font-sans">
      ...
      <header className="bg-white/90 backdrop-blur-md border-b border-[#E2E8F0] sticky top-0 z-20">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4F46E5] shadow-sm">
              <Zap className="h-4.5 w-4.5 text-white" />
            </div>
            <div>
              <span className="text-lg font-bold tracking-tight text-[#0F172A]">Pay<span className="text-[#4F46E5]">Pilot</span></span>
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-semibold text-[#64748B]">
            {['problem','works','features','businesses','faq'].map((id) => (
              <a key={id} href={`#${id}`} className="nav-link hover:text-[#4F46E5] transition-colors capitalize">
          ...
          <button
            ...
            className="btn-press inline-flex items-center gap-1.5 rounded-lg bg-[#4F46E5] hover:bg-[#4338CA] text-xs font-bold text-white py-2 px-4 shadow-sm transition-all"
          >
            Open Demo Dashboard
      ...
      <section className="container mx-auto px-6 pt-20 pb-16 text-center space-y-6 max-w-4xl">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 border border-indigo-200/70 text-[10px] font-bold text-[#4F46E5] uppercase tracking-wider animate-fade-up animate-float">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#0F172A] leading-tight animate-fade-up delay-150">
          ...
          <span className="text-[#4F46E5]">cleaner business payments</span>
        </h1>
        ...
        <div className="flex justify-center gap-3 pt-2 animate-fade-up delay-400">
          <button
            onClick={() => { setErrorMsg(null); setIsAuthModalOpen(true); }}
            className="btn-press rounded-xl bg-[#4F46E5] hover:bg-[#4338CA] text-xs font-bold text-white py-3.5 px-6 shadow-md transition-all"
          >
            Open demo dashboard
          </button>
          <a
        ...
        <div className="reveal w-full max-w-5xl mx-auto rounded-3xl border border-[#E2E8F0] bg-white p-3 shadow-md">
          <div className="rounded-2xl border border-[#F1F5F9] bg-[#F8FAFC] p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { label: 'Reconciled Collections', value: '₦2,850,000.00', sub: 'Auto-matched via webhook', subColor: 'text-[#4338CA]' },
                ...
                { label: 'Collection Efficiency',    value: '86.2%',         sub: 'Automatic clearings rate',      subColor: 'text-[#4F46E5]', valueColor: 'text-[#4F46E5]' },
              ].map((card) => (
      ...
      <section id="problem" className="container mx-auto px-6 py-20 border-t border-[#E2E8F0]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 space-y-4 reveal-left">
            <span className="text-[10px] font-bold text-[#4F46E5] uppercase tracking-wider block">The Challenge</span>
      ...
      <section id="works" className="bg-white border-t border-[#E2E8F0]">
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-2xl mx-auto text-center space-y-3 mb-16 reveal">
            <span className="text-[10px] font-bold text-[#4F46E5] uppercase tracking-wider block">Automatic reconciliation</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={step.n} className="reveal space-y-4 text-center" style={{ transitionDelay: `${step.delay}ms` }}>
                <div className={`h-10 w-10 rounded-xl flex items-center justify-center font-bold text-sm mx-auto transition-all ${step.n === '1' ? 'bg-[#4F46E5] text-white shadow-md shadow-indigo-500/20' : 'bg-indigo-50 text-[#4F46E5] border border-indigo-100'}`}>{step.n}</div>
      ...
      <section id="features" className="container mx-auto px-6 py-20 border-t border-[#E2E8F0]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 space-y-6 reveal-left">
            <span className="text-[10px] font-bold text-[#4F46E5] uppercase tracking-wider block">System Features</span>
      ...
      <section id="businesses" className="bg-white border-t border-[#E2E8F0]">
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-2xl mx-auto text-center space-y-3 mb-16 reveal">
            <span className="text-[10px] font-bold text-[#4F46E5] uppercase tracking-wider block">Use Cases</span>
      ...
      <section id="faq" className="container mx-auto px-6 py-20 border-t border-[#E2E8F0] max-w-3xl">
        <div className="text-center space-y-3 mb-16 reveal">
          <span className="text-[10px] font-bold text-[#4F46E5] uppercase tracking-wider block">FAQ</span>
      ...
      <section className="container mx-auto px-6 py-16 max-w-4xl">
        <div className="reveal rounded-3xl bg-white border border-[#E2E8F0] p-12 text-center space-y-6 shadow-sm">
          ...
          <button
            onClick={() => { setErrorMsg(null); setIsAuthModalOpen(true); }}
            className="btn-press inline-flex items-center gap-1.5 rounded-xl bg-[#4F46E5] hover:bg-[#4338CA] text-xs font-bold text-white py-3.5 px-6 shadow-sm transition-all"
          >
      ...
      <footer className="container mx-auto px-6 py-8 border-t border-[#E2E8F0] flex flex-col sm:flex-row justify-between items-center gap-5 text-[10px] text-[#64748B] font-bold">
        <div className="flex items-center gap-2">
          <div className="h-6 w-6 rounded bg-[#4F46E5] flex items-center justify-center font-bold text-[9px] text-white">P</div>
        ...
        <div className="flex gap-4">
          ...
          <span>&bull;</span>
          <a href="mailto:support@paypilot.co" className="hover:text-[#4F46E5] transition-colors">Support</a>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-md rounded-3xl bg-white border border-[#E2E8F0] p-8 shadow-xl animate-zoom-in text-left relative">
            ...
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div>
                <span className="text-base font-bold tracking-tight text-[#0F172A]">Pay<span className="text-[#4F46E5]">Pilot</span></span>
            ...
            <div className="flex border-b border-[#E2E8F0] pb-px mb-6 text-xs font-bold">
              {(['login', 'register'] as const).map((tab) => (
                <button
                  ...
                  className={`pb-3 px-6 transition-all border-b-2 capitalize ${activeTab === tab ? 'border-[#4F46E5] text-[#4F46E5]' : 'border-transparent text-[#64748B] hover:text-[#0F172A]'}`}
                >
